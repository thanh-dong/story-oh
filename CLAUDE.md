...
This project is indexed by GitNexus as **story-oh** (684 symbols, 1531 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/story-oh/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/story-oh/context` | Codebase overview, check index freshness |
| `gitnexus://repo/story-oh/clusters` | All functional areas |
| `gitnexus://repo/story-oh/processes` | All execution flows |
| `gitnexus://repo/story-oh/process/{name}` | Step-by-step execution trace |
